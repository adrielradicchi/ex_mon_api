defmodule ExMon.TrainerTest do
  ...
  describe "changeset/1" do
    test "when all params are valid, returns a valid changeset" do
      ...
      assert %Ecto.Changeset{changes: %{name: "Adriel", password: "123456"}, errors: [], data: %ExMon.Trainer{}, valid?: true} = response
    end
  ...
  describe "build/1" do
    test "when all params are valid, returns a trainer struct" do
      ...
      assert {:ok, %Trainer{name: "Adriel", password: "123456"}} = response
    end
